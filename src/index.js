...
import { ClerkProvider, CreateOrganization, Protect, RedirectToSignIn, SignIn, SignUp, SignedIn, SignedOut, useAuth } from "@clerk/clerk-react";
import { BrowserRouter, Routes, Route, useNavigate } from "react-router-dom";
import OkosPage from "./OkosPage";
import AuthPage from "./AuthPage";
import companyUsersMap from "./companyMap";
import ShippiePage from "./ShippiePage";
  ...
  return (
    ...
    <LogUserId setCompanyName={setCompanyName} />
      <Routes>
        ...
        <Route
          path="/sign-in/*"
          element={<SignIn redirectUrl={`/${companyName}`}  routing="path" path="/sign-in" />}
        />
        <Route
          path="/sign-up/*"
        ...
        <Route
          ...
          element={<CreateOrganization  afterCreateOrganizationUrl={`/reports`}/>}
        />
        <Route
          path="/reports/*"
          element={<ReportsPage />}
